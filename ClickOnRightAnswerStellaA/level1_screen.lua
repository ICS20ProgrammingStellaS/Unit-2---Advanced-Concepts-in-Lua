...
function scene:create( event )
    ...
    answerTextObject = display.newText("", display.contentWidth*.5, display.contentHeight/2, nil, 50 )
    wrongAnswer1TextObject = display.newText("", display.contentWidth*.4, display.contentHeight/2, nil, 50 )
